...
1. Create your own copy of this repo:
   - Follow this link: [Create repo from template](https://github.com/new?template_name=project_contact_manager_python_init&template_owner=codelingdotdev)
   - Or click _Use this template_ > _Create new repository_ button on this screen
2. Give the repository a name (eg: project_contact_manager_python)
